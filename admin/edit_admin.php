...
?>
     <?php
						include 'koneksi.php';
						$nik       = @$_GET['nik'];
						$db  = mysqli_query($koneksi, "select * from tbl_user where NIK='$nik'");
						$row        = mysqli_fetch_array($db); 
				  ?>	
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Halaman Edit Admin</h6>
                </div>
                <div class="card-body">
                <form autocomplete = "off" action="proseseditadmin.php" required>
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK</label>
                      <input type="number" class="form-control" value ="<?php echo $row['NIK']; ?>" name="nik"  required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value ="<?php echo $row['password']; ?>" name="pwd" required>
                    </div>
                    <div class="form-group">
