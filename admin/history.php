				...
				<form autocomplete = "off" method="GET" action="history_user.php">
                  <div class="form-group">
                    ...
                    <label for="exampleInputEmail1">Petugas (Sopir)</label>
                       <select class="form-control" id="exampleFormControlSelect1" name= "petugas" required >
                    ...
                    <label for="exampleInputEmail1">Tanggal</label>
                       <select class="form-control" id="exampleFormControlSelect1" name= "tanggal" required >
