...
$cek = mysqli_num_rows($cekkonfirm);
		...
		if($cek>0){
			...
			$ambil_jadwal = mysqli_query($koneksi, "SELECT id_jadwal FROM jadwal where status='aktif'");
    if(mysqli_num_rows($ambil_jadwal) <0){
        echo "";
        }else{
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Selamat datang di halaman Admin</h6>
				...
				<?php 
                                ...
                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tbl_user WHERE nik='$nik'")or die(mysql_error());
