            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Data Profile Petugas Kebersihan</h6>
				...
				<?php 
                                ...
                                $query_mysql = mysqli_query($koneksi, "SELECT * FROM tbl_user WHERE nik='$nik' and password='$password'")or die(mysql_error());
